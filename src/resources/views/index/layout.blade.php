...
<body
  ...
  <footer class="bg-yideli-dark text-white pt-20 pb-10">
    <div
      ...
      <div class="lg:col-span-2 mt-[-40px]">
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-white/70">
          <li><a href="{{ route('page.show', ['lang' => $lang, 'slug' => 'about-us']) }}" class="hover:text-white transition">About Us</a></li>
          <li><a href="{{ route('production-process', ['lang' => $lang]) }}" class="hover:text-white transition">Production Process</a></li>
          <li><a href="{{ route('news.index', ['lang' => $lang]) }}" class="hover:text-white transition">News</a></li>
          <li><a href="{{ route('inquire.form', ['lang' => $lang]) }}" class="hover:text-white transition">Contact Us</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-white/70">
          <li><a href="#products" class="hover:text-white transition">Planner & Diaries</a></li>
          <li><a href="#notebooks" class="hover:text-white transition">Spiral Notebook</a></li>
