...
<body
  ...
  <div class="fixed end-5 bottom-5 z-40 flex flex-col items-end gap-1.5">
    ...
    <div class="group relative flex flex-col items-end">
      <div class="pointer-events-none absolute bottom-full end-0 mb-2 translate-y-2 opacity-0 transition duration-200 group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-y-0 group-focus-within:opacity-100">
