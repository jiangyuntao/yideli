  ...
  <div class="bg-yideli-base py-20 border-b border-yideli-line">
    <div class="max-w-[1200px] mx-auto px-6 lg:px-12 text-center">
      ...
      <p class="text-gray-600 max-w-2xl mx-auto font-light text-lg">
        Whether you have a question about products, pricing, or OEM customization, our team is ready to answer all your
        questions.
      </p>
    </div>
  </div>
        ...
        <form class="space-y-8" action="#" method="POST">
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="relative">
              <input
                class="input-field block w-full px-0 py-2 bg-transparent border-b border-gray-300 focus:outline-none focus:border-yideli-dark transition text-gray-900 placeholder-transparent"
                id="company" name="company" type="text" placeholder="">
              <label
                class="absolute start-0 top-2 text-gray-400 text-sm transition-all duration-300 origin-left cursor-text"
                for="company">Company
                Name</label>
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="relative">
              <input
                class="input-field block w-full px-0 py-2 bg-transparent border-b border-gray-300 focus:outline-none focus:border-yideli-dark transition text-gray-900 placeholder-transparent"
                id="phone" name="phone" type="tel" placeholder="">
              <label
                class="absolute start-0 top-2 text-gray-400 text-sm transition-all duration-300 origin-left cursor-text"
                for="phone">Phone
                Number</label>
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-4">
              ...
              <label class="inline-flex items-center cursor-pointer">
                <input class="w-4 h-4 text-yideli-dark border-gray-300 rounded focus:ring-yideli-dark" name="interest"
                  type="checkbox" valu e="distributorship">
          ...
          <div class="relative mt-8">
            <textarea
              class="input-field block w-full px-0 py-2 bg-transparent border-b border-gray-300 focus:outline-none focus:border-yideli-dark transition text-gray-900 placeholder-transparent resize-none"
              id="message" name="message" rows="4" placeholder="" required></textarea>
            <label
              class="absolute start-0 top-2 text-gray-400 text-sm transition-all duration-300 origin-left cursor-text"
              for="message">Message / Specific Requirements *</label>

          </div>

          <div class="flex items-center justify-between pt-4">
            <p class="text-xs text-gray-400 max-w-xs">By clicking submit, you agree to our Privacy Policy and allow
              Yideli
