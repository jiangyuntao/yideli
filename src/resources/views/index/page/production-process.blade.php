...
@section('main')
  <div class="relative bg-yideli-base py-12 md:py-12 overflow-hidden">
    ...
    <div class="max-w-[1600px] mx-auto px-6 md:px-12 text-center relative z-10">
  ...
  <section class="max-w-[1200px] mx-auto px-6 md:px-12 py-12 md:py-12 space-y-24">
    ...
    <div class="grid md:grid-cols-12 gap-12 md:gap-20 items-center">
      ...
      <div class="order-1 md:col-span-5 md:order-2">
        <img src="{{ asset('images/process/1.jpg') }}" class="w-full h-full object-cover rounded-sm shadow-xl"
          alt="Design Process">
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-12 gap-12 md:gap-20 items-center">
      <div class="order-1 md:col-span-5 md:grid md:grid-cols-2 md:gap-4">
        <img src="{{ asset('images/process/2.png') }}" class="w-full h-full object-cover rounded-sm shadow-xl">
        <img src="{{ asset('images/process/3.png') }}" class="w-full h-full object-cover rounded-sm shadow-xl">
      </div>
      <div class="order-2 md:col-span-7 relative">
        <h2 class="text-4xl font-serif font-bold text-yideli-dark mb-4 relative z-10 md:text-right">Material Selection</h2>
        <p class="text-gray-800 text-lg leading-relaxed relative z-10">
    ...
    <div class="grid md:grid-cols-12 gap-12 md:gap-20 items-center">
      ...
      <div class="order-1 md:col-span-5 md:order-2 relative">
        <img src="{{ asset('images/process/4.png') }}" class="w-full h-full object-cover rounded-sm shadow-xl"
          alt="Raw Material">
      </div>
    </div>
  ...
  <section class="bg-yideli-dark text-white py-10 md:py-18">
    <div class="max-w-[1600px] mx-auto px-6 md:px-12 text-center">
