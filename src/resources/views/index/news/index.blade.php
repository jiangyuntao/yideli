    ...
    <section
      ...
      <div
        ...
        <a class="relative overflow-hidden h-64 lg:h-96"
          ...
          @endphp
          <img class="w-full h-full object-cover news-image transition duration-700" src="{{ $featImg }}"
      ...
      <div class="lg:col-span-8 space-y-12">
        ...
        @forelse ($entries as $entry)
          <article
            ...
            <a class="w-full md:w-1/3 aspect-[4/3] overflow-hidden bg-gray-100"
              ...
              @endphp
              <img class="w-full h-full object-cover news-image transition duration-700" src="{{ $img }}"
                alt="{{ $entry->title }}">
            </a>
            <div class="w-full md:w-2/3 flex flex-col justify-center">
              ...
              <div class="relative w-max">
                <a class="text-xs font-bold uppercase tracking-widest text-yideli-dark block"
                  href="{{ route('news.show', ['lang' => $lang, 'slug' => $entry->slug]) }}">Read More</a>
                <div
        ...
        @empty
          <div class="py-10 text-center text-gray-500">
            ...
            @if (request('q'))
              <a class="text-yideli-dark underline mt-2 block" href="{{ route('news.index', ['lang' => $lang]) }}">Clear
                Search</a>
            @endif
          </div>
        @endforelse
        ...
        <div>
          ...
          <form class="relative" action="{{ route('news.index', ['lang' => $lang]) }}" method="GET">
            <input
              ...
              name="q" type="text" value="{{ request('q') }}" placeholder="Search news...">
