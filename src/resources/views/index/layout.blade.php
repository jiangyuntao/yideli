...
<body
  ...
  <div class="fixed bottom-3 end-3 z-40 flex flex-col items-end gap-1.5 sm:bottom-5 sm:end-5">
    <a class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-xs font-bold uppercase tracking-[0.06em] text-white shadow-[0_14px_40px_rgba(0,0,0,0.22)] transition hover:bg-[#1ebe5d] focus:outline-none focus:ring-2 focus:ring-[#25D366]/30 focus:ring-offset-2 sm:h-auto sm:w-[180px] sm:gap-2 sm:px-4 sm:py-3"
    ...
    <div class="group relative flex flex-col items-end">
      ...
      <a class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-xs font-bold uppercase tracking-[0.06em] text-white shadow-[0_14px_40px_rgba(0,0,0,0.22)] transition hover:bg-[#1ebe5d] focus:outline-none focus:ring-2 focus:ring-[#25D366]/30 focus:ring-offset-2 sm:h-auto sm:w-[180px] sm:gap-2 sm:px-4 sm:py-3"
        ...
        <span class="hidden sm:inline">{{ $floatingWhatsappLabel }}</span>
      </a>
    </div>
  </div>
