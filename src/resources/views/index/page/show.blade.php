...
@section('main')
    ...
    <div class="max-w-[1600px] mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
      <div class="relative z-10">
        ...
        <p class="text-gray-600 text-lg leading-relaxed mb-8 font-light max-w-xl">
          Located in Taizhou, China, Yideli Stationery has grown from a humble workshop into a global manufacturing partner. We believe that stationery is not just a tool, but a vessel for thought and creativity.
        </p>
        <img src="https://images.unsplash.com/photo-1606857521015-7f9fcf423740?q=80&w=800&auto=format&fit=crop"
             alt="Office Vibe" class="w-full h-64 object-cover rounded-sm shadow-lg grayscale hover:grayscale-0 transition duration-700">
      </div>
      <div class="relative h-full min-h-[400px]">
        <img src="{{ asset('images/notebook-1.jpg') }}"
             alt="Factory Production" class="absolute inset-0 w-full h-full object-cover rounded-sm shadow-2xl">
      </div>
    </div>
  </section>

  <section class="bg-yideli-dark text-yideli-base py-16">
    <div class="max-w-[1600px] mx-auto px-6 lg:px-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
      <div>
    ...
    <div class="max-w-[1200px] mx-auto">
      <div class="text-center mb-20">
        ...
        <p class="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
            Taizhou Yideli Stationery Co., Ltd. specializes in the R&D, production, and sales of high-end notebooks and writing instruments.
            With advanced automated injection molding machinery and a skilled assembly team, we offer comprehensive OEM & ODM solutions for global brands.
      ...
      <div class="grid md:grid-cols-3 gap-6">
        <div class="space-y-4">
           <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=600&auto=format&fit=crop" class="w-full h-80 object-cover grayscale hover:grayscale-0 transition duration-500">
        ...
        <div class="space-y-4 md:translate-y-12">
           <img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?q=80&w=600&auto=format&fit=crop" class="w-full h-80 object-cover grayscale hover:grayscale-0 transition duration-500">
        ...
        <div class="space-y-4">
           <img src="https://images.unsplash.com/photo-1664575602276-acd073f104c1?q=80&w=600&auto=format&fit=crop" class="w-full h-80 object-cover grayscale hover:grayscale-0 transition duration-500">
  ...
  <section class="py-20 bg-yideli-base border-t border-yideli-line">
    <div class="max-w-[1600px] mx-auto px-6 lg:px-12 text-center">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8 items-center justify-center opacity-80 grayscale hover:grayscale-0 transition-all duration-500">
          <div class="flex flex-col items-center gap-2">
            <div class="h-16 w-16 bg-white rounded-full flex items-center justify-center border border-yideli-line shadow-sm">
      ...
      <div class="mt-12 max-w-4xl mx-auto">
        <img src="{{ asset('images/cert.jpg') }}" alt="All Certifications" class="w-full h-auto object-contain mix-blend-multiply opacity-90">
      </div>
    </div>
  </section>
  ...
  <section class="py-24 bg-yideli-dark text-white text-center">
    <div class="max-w-2xl mx-auto px-6">
      ...
      <a href="#contact" class="inline-block border border-white px-10 py-4 text-sm tracking-widest uppercase hover:bg-white hover:text-yideli-dark transition duration-300">
