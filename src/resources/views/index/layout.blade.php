...
<head>
  ...
  <link rel="preconnect"
        ...
        crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;500;700&family=Inter:wght@300;400;500;600;700&family=Noto+Sans+SC:wght@300;400;500;700&display=swap"
        rel="stylesheet">
...
<body
  ...
  <header x-data="{ mobileMenu: false, searchOpen: false }"
    ...
    <div class="max-w-[1920px] mx-auto px-6 lg:px-12 h-20 flex justify-between items-center">
      <div class="flex-shrink-0 me-8">
        <a href="{{ route('index', ['lang' => $lang]) }}"
           class="block">
          <img src="{{ asset('images/logo_big.jpg') }}"
               alt="Yideli Logo"
      ...
      <nav class="hidden lg:flex gap-16 text-sm font-medium tracking-wide "
        ...
        <a href="{{ route('product.index', ['lang' => $lang]) }}"
           class="hover:text-gray-300 transition">PRODUCT
          DISPLAY</a>
        <a href="{{ route('news.index', ['lang' => $lang]) }}"
           class="hover:text-gray-300 transition">NEWS</a>
        <a href="{{ route('inquire.form', ['lang' => $lang]) }}"
           class="hover:text-gray-300 transition">CONTACT
          US</a>
      </nav>
      ...
      <div class="flex items-center gap-6"
        ...
        <div class="relative"
          ...
          <button @click="open = !open"
                  ...
                  style="color: rgb(239 245 230);"> <span class="font-bold"
    ...
    <div x-show="mobileMenu"
         x-transition
         x-cloak
         class="lg:hidden absolute top-full start-0 w-full bg-yideli-base border-t border-yideli-line shadow-lg">
      <div class="flex flex-col p-6 gap-4 text-lg font-serif text-yideli-dark">
        <a href="{{ route('index', ['lang' => $lang]) }}"
           class="py-2 border-b border-yideli-line/30">HOME</a>
        <a href="{{ route('page.show', ['lang' => $lang, 'slug' => 'about-us']) }}"
        ...
        <a href="{{ route('inquire.form', ['lang' => $lang]) }}"
           class="py-2 border-b border-yideli-line/30">CONTACT
          US</a>
      </div>
    </div>
  </header>
  ...
  <footer class="bg-yideli-dark text-white pt-20 pb-10">
    <div
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-white/70">
          ...
          <li><a href="{{ route('news.index', ['lang' => $lang]) }}"
               class="hover:text-white transition">News</a></li>
          <li><a href="{{ route('inquire.form', ['lang' => $lang]) }}"
               class="hover:text-white transition">Contact
              Us</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-white/70">
          <li><a href="#"
               class="hover:text-white transition">Planner & Diaries</a></li>
          <li><a href="#"
               class="hover:text-white transition">Spiral Notebook</a></li>
          <li><a href="#"
               class="hover:text-white transition">Notebook</a></li>
          <li><a href="#"
               class="hover:text-white transition">Elastic band notebook</a></li>
          <li><a href="#"
               class="hover:text-white transition">Address book</a></li>
          <li><a href="#"
               class="hover:text-white transition">Folders &amp; Organizers</a></li>
        </ul>
      </div>
    ...
    <div
      ...
      <div class="flex gap-6 mt-4 md:mt-0">
        ...
        <a href="#"
           class="hover:text-white transition">Terms of Use</a>
      </div>
    </div>
  </footer>
